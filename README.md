...
Built for ~8-10 lab members. Runs on a single AWS EC2 instance. 466+ backend tests passing.
...
│   └── tests/                   pytest tests (466+ passing)
│
├── frontend/
│   └── src/
...
docker compose exec api pytest tests/                           # full suite (466+ tests)
