...
Built for ~8-10 lab members. Runs on a single AWS EC2 instance. 474+ backend tests passing.
...
│   └── tests/                   pytest tests (474+ passing)
│
├── frontend/
│   └── src/
...
docker compose exec api pytest tests/                           # full suite (474+ tests)
