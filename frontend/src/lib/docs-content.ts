    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          '<strong>Call peaks</strong> using MACS2 or SEACR with HOMER annotation',
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          '<strong>Peak Caller</strong> -- How do MACS2 and SEACR differ, and when should you use each?',
