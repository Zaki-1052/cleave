          ...
          <div className="mb-3 flex items-center justify-between">
            ...
            {!editing && (
              <button
                ...
                className="rounded text-xs font-medium text-primary transition-colors duration-150 hover:text-primary/80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
              >
                Manage
              </button>
            )}
