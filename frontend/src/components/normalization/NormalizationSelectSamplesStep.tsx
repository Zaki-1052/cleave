...
export function NormalizationSelectSamplesStep({
  ...
  return (
    <Card>
      ...
      <div className="mb-3 rounded-md bg-blue-50 dark:bg-blue-950 px-3 py-2 text-sm text-blue-700 dark:text-blue-300">
      ...
      {!minSamplesValid && samples.length > 0 && (
        <div className="mb-3 rounded-md bg-amber-50 dark:bg-amber-950 px-3 py-2 text-sm text-amber-700 dark:text-amber-300">
          At least 2 samples are required for normalization.
        </div>
      )}
