  ...
  const steps = [
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          />
          <div>
            <label htmlFor="pathway-notes" className="font-mono text-[11px] font-medium uppercase tracking-[0.08em] text-muted-foreground">
              Notes
            </label>
            <textarea
              id="pathway-notes"
    ...
    },
    {
      ...
      content: jobsLoading ? (
        ...
        <EmptyState
          icon={Inbox}
          title="No DE analysis jobs"
          description="No completed DE analysis jobs found. Run a DESeq2 analysis first."
        />
      ) : (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-xs text-muted-foreground">
                    ID: <span className="font-mono tabular-nums">{job.id}</span> · Genome: {String(job.params?.reference_genome ?? '—')} ·{' '}
    ...
    },
    {
      ...
      content: (
        <div className="space-y-5">
          ...
          <div>
            <label className="font-mono text-[11px] font-medium uppercase tracking-[0.08em] text-muted-foreground">Gene List</label>
              ...
              <table className="w-full text-sm">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="font-mono font-medium">{referenceGenome}</td>
                  </tr>
                  <tr>
